    ...
    <div className="border-b border-neutral-800 pb-24">
      ...
      >
        ...
        <motion.div
          ...
          initial="initial"
          animate="animate"
          className="rounded-2xl border-4 border-neutral-800 p-4 bg-blue-600 shadow-lg transition-transform transform hover:scale-105"
        >
        ...
        <motion.div
          ...
          initial="initial"
          animate="animate"
          className="rounded-2xl border-4 border-neutral-800 p-4 bg-green-800 shadow-lg transition-transform transform hover:scale-105"
        >
